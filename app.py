...
<style>
    ...
    /* 煉丹爐與暗器專屬背景 */
    .alchemy-bg {
        background: linear-gradient(to bottom, rgba(30,10,10,0.8), rgba(60,10,10,0.6)), url('https://media.giphy.com/media/3o7bswzWyyZmtTEgRq/giphy.gif');
        background-size: cover;
        background-position: center;
        border: 1px solid #FF4B4B;
    }
    .dark-arts-bg {
        background: linear-gradient(to bottom, rgba(15,5,25,0.9), rgba(30,10,50,0.7));
...
# 載入資料
with st.spinner("⏳ 正在匯聚天地靈氣，讀取宗門玉簡..."):
...
with tab0:
    ...
    with stat_c1:
        st.markdown(f"""
        <div class='glass-card' style='text-align: center; height: 140px; display:flex; flex-direction:column; justify-content:center;'>
    ...
    with stat_c2:
        st.markdown(f"""
        <div class='glass-card' style='display: flex; justify-content: space-around; text-align: center; height: 140px; align-items:center;'>
            <div>
    ...
    with stat_c3:
        st.markdown("<div class='glass-card' style='height: 140px; display:flex; flex-direction:column; justify-content:center;'>", unsafe_allow_html=True)
    ...
    with play_c1:
        ...
        st.markdown("<div class='glass-card alchemy-bg'>", unsafe_allow_html=True)
        st.markdown("<h3 style='margin-top:0; text-shadow: 0 2px 4px #000;'>🎲 激進煉丹爐</h3>", unsafe_allow_html=True)
        st.markdown(f"<p style='color:#DDD; text-shadow: 0 1px 3px #000;'>投入 50 點戰力博取仙丹。<br>成功率：<b style='color:#92FE9D;'>{base_win}%</b> / 炸爐率：<b style='color:#FF4B4B;'>{base_rug}%</b></p>", unsafe_allow_html=True)
    ...
    with play_c2:
        st.markdown("<div class='glass-card dark-arts-bg'>", unsafe_allow_html=True)
        st.markdown("<h3 style='margin-top:0; text-shadow: 0 2px 4px #000;'>🥷 宗門暗算</h3>", unsafe_allow_html=True)
    ...
    with daily_col:
        ...
        st.markdown("<h4 style='margin-top:0;'>🥠 天機閣</h4>", unsafe_allow_html=True)
